...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/jcifs-pool) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)

jcifs-pool provides a connection-pooled SMB/CIFS file-access toolkit on top of the org.codelibs jcifs 2.1.11 client (an SMB2-capable fork of JCIFS)
...
```groovy
implementation 'io.github.easy4j:jcifs-pool:3.0.x.x.20260630-SNAPSHOT'
```
